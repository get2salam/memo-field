  ...
  "slug": "memo-field",
  "title": "Memo Field",
  "tagline": "Capture notes with context, signal, and next action before they dissolve.",
  "domainLabel": "memos",
  "itemLabel": "memo",
  "emptyTitle": "No memos yet",
  "emptyBody": "Drop in the ideas, reminders, and lessons worth keeping.",
  "seedTitle": "Founder memo field",
  "seedSubtitle": "A simple board for notes that deserve more than a text file graveyard.",
  "categories": [
    "Idea",
    "Lesson",
    "Reminder",
  ...
  "items": [
    {
      ...
      "score": 9,
      "effort": 1,
      "note": "People remember transformation, not menus."
    },
    {
      "title": "Ask why this matters now",
      "category": "Reminder",
      "state": "Fresh",
      "score": 8,
      "effort": 1,
      "note": "Urgency sharpens product decisions and copywriting alike."
    },
    {
      "title": "Find a better legal onboarding example",
      "category": "Research",
      "state": "Sorted",
      "score": 7,
      "effort": 3,
      "note": "Need one benchmark with strong first-time UX."
    }
  ]
};
