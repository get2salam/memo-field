...
const SPEC = {
  "slug": "memo-field",
  "title": "Memo Field",
  "description": "Capture notes with context, signal, and next action before they dissolve.",
  "lede": "Keep useful notes alive with context, next action, recall value, and revisit dates.",
  "heroEyebrow": "Notes workspace",
  "boardTitle": "Memo field board",
  "boardSubtitle": "A local-first board for notes that should become action instead of disappearing.",
  "accent": "Notes matter more when context, next action, and revisit timing are captured while the memory is still warm.",
  "itemLabel": "memo",
  "itemPluralLabel": "Memos",
  "labels": {
    "title": "Memo",
    "note": "Memo note",
    "category": "Memo type",
  ...
  "textOne": {
    "label": "Context",
    "default": "Where or why this came up"
  },
  "textTwo": {
    "label": "Next action",
    "default": "What to do with this note"
  },
  "date": {
    "label": "Review date"
  },
  ...
  "defaults": {
    "note": "Write the part you do not want future-you to forget."
  },
  "stats": {
    "totalLabel": "Memos",
    "motionLabel": "Linked",
  ...
  "insights": {
    "topLabel": "Most valuable note",
    "dateLabel": "Next review",
    "metricLabel": "Highest recall value"
  },
  "queue": {
    "eyebrow": "Memo queue",
    "title": "Which notes should be revisited next",
    "empty": "Actioned and archived memos fall out of the active queue."
  },
  "mix": {
    "eyebrow": "Memo mix",
    "title": "What kind of notes are accumulating"
  },
  "emptyTitle": "No memos yet",
  "emptyBody": "Add ideas, call notes, research fragments, and reminders worth keeping alive.",
  "actions": [
    {
      "id": "link-note",
      "label": "Link note",
      ...
      "days": 2,
      "fromToday": true,
      "toast": "Linked this memo to a next step."
    },
    {
      "id": "raise-recall",
      "label": "Raise recall value",
      "mode": "advance",
      "metricDelta": 1,
      "toast": "Raised the recall value on this memo."
    },
    {
      "id": "actioned",
      "label": "Mark actioned",
      ...
      "days": 0,
      "fromToday": true,
      "toast": "Marked this memo actioned."
    }
  ],
  "theme": {
    "primary": "#fb7185",
  ...
  "items": [
    {
      "title": "Lawyer phrasing from discovery call",
      "category": "Call",
      "state": "Fresh",
      "score": 8,
      "effort": 2,
      "metric": 7,
      "textOne": "Discovery call notes",
      "textTwo": "Reuse in homepage copy",
      "date": "2026-04-25",
      "note": "The exact wording felt strong because it came from frustration, not marketing language."
    },
    {
      "title": "Search benchmark idea",
      "category": "Research",
      "state": "Linked",
      "score": 7,
      "effort": 3,
      "metric": 8,
      "textOne": "Benchmark notebook",
      "textTwo": "Turn into comparison post",
      "date": "2026-04-27",
      "note": "Could become both a proof asset and a content piece if made concrete."
    },
    {
      ...
      "effort": 1,
      "metric": 6,
      "textOne": "Friday shutdown",
      "textTwo": "Review next week priorities",
      "date": "2026-04-24",
      "note": "Simple reminder, but useful for protecting Monday clarity."
    }
  ]
};
